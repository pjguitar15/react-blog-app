    ...
    <main className='bg-slate-100 w-full p-7'>
      ...
      <div className='bg-white rounded-lg mt-8 border'>
        <div className='flex px-6 py-4 poppins-semibold text-sm text-violet-900 border-b'>
          ...
          <h5 className='w-1/12'>Created</h5>
...
const TableRow = ({
  ...
  return (
    <div className='flex px-6 py-4 poppins-regular text-sm'>
      <h5 className='text-cyan-600 w-2/12'>{name}</h5>
      <h5 className='text-gray-500 flex gap-2 items-center w-3/12'>
        <MdContentCopy />
        {url}
      </h5>
      <h5 className='text-gray-500 w-2/12'>{author}</h5>
      <h5 className='text-gray-500 w-1/12'>{views}</h5>
      <h5 className='text-gray-500 w-1/12'>{comments}</h5>
      <h5 className='text-gray-500 w-1/12'>{category}</h5>
      <h5 className='text-gray-500 w-1/12'>{created}</h5>
      <div>
